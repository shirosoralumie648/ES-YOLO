...
def get_flops(model, imgsz=640):
    ### Modified by Diego Augusto Silva to include Hidden States
    try:
        print(imgsz)
        ...
        hidden_states = {"0": None, "1": None, "2": None, "3": None, "4": None}
        flops = thop.profile(deepcopy(model), [im, hidden_states], verbose=False)[0] / 1E9 * 2  # stride GFLOPs
...
class ModelEMA:
    ...
    def __init__(self, model, decay=0.9999, tau=2000, updates=0):
        ...
        #self.ema = copy.copy(de_parallel(model)).eval()
